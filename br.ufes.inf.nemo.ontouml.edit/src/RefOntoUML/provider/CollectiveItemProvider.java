...
/**
 * This is the item provider adapter for a {@link RefOntoUML.Collective} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollectiveItemProvider
	 ...
	 * @generated
	 */
	public CollectiveItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefOntoUMLPackage.eINSTANCE.getCollective_IsExtensional(),
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Collective"));
	}
	...
	public String getText(Object object) {
		String label = ((Collective)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Collective_type") :
			getString("_UI_Collective_type") + " " + label;
	}
