 ...
 *
 */
public class AutoSelectionDialog extends JDialog {
	...
	public static void open(TheFrame frame) 
	{
		try {
			...
			AutoSelectionDialog dialog = new AutoSelectionDialog(frame);
	 ...
	 * @param frame
	 */
	public AutoSelectionDialog(TheFrame frame)
	{
		this();
	 ...
	 * Create the dialog.
	 */
	public AutoSelectionDialog() 
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(AutoSelectionDialog.class.getResource("/resources/br/ufes/inf/nemo/move/autoselection-16x16.png")));
