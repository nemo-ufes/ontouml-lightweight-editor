...
public class janO_OU__TCustomer {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					janO_OU__TCustomer window = new janO_OU__TCustomer();
	...
	private void initialize() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "O-OU-TCustomer", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblNewLabel = new JLabel("Organizational Unit Target Customer");
		...
		JLabel lblRepresentsPersonsAs = new JLabel("Represents Organizations and Organizations Units as Target Customers.");
