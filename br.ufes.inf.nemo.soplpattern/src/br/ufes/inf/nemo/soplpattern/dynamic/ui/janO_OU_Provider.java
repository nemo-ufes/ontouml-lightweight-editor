...
public class janO_OU_Provider {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					janO_OU_Provider window = new janO_OU_Provider();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Organization Unit Provider");
		...
		JLabel lblRepresentsPersonsAs = new JLabel("Represents Organizations and Organizations Units as Service Providers.");
