...
//	}
	...
	protected void initialize() {
		...
		panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "SOClaim", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblNewLabel = new JLabel("Service Offering Claim");
