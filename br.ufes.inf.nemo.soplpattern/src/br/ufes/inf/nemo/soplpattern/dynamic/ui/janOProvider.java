...
public class janOProvider {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					janOProvider window = new janOProvider();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 347, 229);
		...
		textField_1.setBounds(160, 50, 126, 20);
		panel.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblNewLabel = new JLabel("Organization");
		lblNewLabel.setBounds(46, 25, 85, 14);
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Service Provider");
		lblNewLabel_1.setBounds(192, 25, 78, 14);
		...
		JLabel lblRepresentsPersonsAs = new JLabel("Represents organizations  as Service Providers");
		lblRepresentsPersonsAs.setBounds(73, 140, 233, 14);
