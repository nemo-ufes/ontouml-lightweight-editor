 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getLeftMultiplicity <em>Left Multiplicity</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getRightMultiplicity <em>Right Multiplicity</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getLeftExpression <em>Left Expression</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getRightExpression <em>Right Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getArrowOperation()
 * @model
 * @generated
 */
public interface ArrowOperation extends Expression {
	 ...
	 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getArrowOperation_LeftMultiplicity()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getLeftMultiplicity <em>Left Multiplicity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getArrowOperation_RightMultiplicity()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getRightMultiplicity <em>Right Multiplicity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getArrowOperation_LeftExpression()
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getLeftExpression <em>Left Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getArrowOperation_RightExpression()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.ontouml.alloy.ArrowOperation#getRightExpression <em>Right Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
