...
/**
 * This is the item provider adapter for a {@link RefOntoUML.PackageImport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefOntoUMLPackage.eINSTANCE.getPackageImport_Visibility(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefOntoUMLPackage.eINSTANCE.getPackageImport_ImportedPackage(),
				 true,
				 false,
				 true,
				 null,
