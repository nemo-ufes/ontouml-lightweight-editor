...
public class SimulationRibbonBand extends JRibbonBand {
	...
	{		
		...
		analyzerButton = new JCommandButton("Alloy",getResizableIconFromResource("resources/icon/alloy-36x36.png"));
		searchButton = new JCommandButton("AntiPattern",getResizableIconFromResource("resources/icon/search-36x36.png"));
