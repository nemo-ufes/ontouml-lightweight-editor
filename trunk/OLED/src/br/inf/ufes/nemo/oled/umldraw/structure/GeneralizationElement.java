...
import br.inf.ufes.nemo.oled.draw.CompositeNode;
import br.inf.ufes.nemo.oled.draw.Diagram;
...
import br.inf.ufes.nemo.oled.umldraw.shared.UmlLabelFormatter;
...
public final class GeneralizationElement extends BaseConnection {
	...
	public void setupNameLabel()
	{
		...
		if(getGeneralization() != null)
			...
			{
				nameLabel.setSource(new UmlModelElementLabelSource(getGeneralization().getGeneralizationSet().get(0)));
			}
	}
