...
public final class ValidationResources {

	private ResourceBundle validationResources =
		ResourceBundle.getBundle("resources.br.inf.ufes.nemo.oled.ui.ontouml-constraints");

	private static ValidationResources instance = new ValidationResources();
	 ...
	 */
	public static ValidationResources getInstance() { return instance; }
