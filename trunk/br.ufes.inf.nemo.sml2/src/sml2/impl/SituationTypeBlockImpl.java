 ...
 * <ul>
 *   <li>{@link sml2.impl.SituationTypeBlockImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SituationTypeBlockImpl extends NodeImpl implements SituationTypeBlock {
	...
	protected EClass eStaticClass() {
		return Sml2Package.Literals.SITUATION_TYPE_BLOCK;
	}
	...
	public EList<Node> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Node>(Node.class, this, Sml2Package.SITUATION_TYPE_BLOCK__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Sml2Package.SITUATION_TYPE_BLOCK__ELEMENTS:
