    ...
    text1.addKeyListener(new KeyListener() {
      ...
      public void keyReleased(KeyEvent e) {
        if (!text1.getText().isEmpty()) {
          ...
          if(text1.getText().compareToIgnoreCase("fim")==0) ((MyWizard)getWizard()).canFinish=true;
          else ((MyWizard)getWizard()).canFinish=false;
          ((MyWizard)getWizard()).getContainer().updateButtons();
        }
      }
