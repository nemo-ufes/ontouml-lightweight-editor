	...
	public void AutoSelectionActionPerformed(ActionEvent event)
	{
		if (rbAllAncestors.isSelected())
		{
			if (ModelTree.getTreeFor(project)==null) return;       		    	
		   	String msg = DiagramManager.doAutoCompleteSelection(OntoUMLParser.ALL_ANCESTORS,project);       	   				    	
	   		JOptionPane.showMessageDialog(
	   			frame,msg,"All ancestors",JOptionPane.INFORMATION_MESSAGE,
	   			new ImageIcon(AutoCompletionDialog.class.getResource("/resources/icon/completion-36x36.png"))
	   		); 
		}
		if (rbAllAncestorsDescendants.isSelected())
		{
			if (ModelTree.getTreeFor(project)==null) return;       		    	
		   	String msg = DiagramManager.doAutoCompleteSelection(OntoUMLParser.COMPLETE_HIERARCHY,project);       	   				    	
	   		JOptionPane.showMessageDialog(
		...
		{
			if (ModelTree.getTreeFor(project)==null) return;       		    	
		   	String msg = DiagramManager.doAutoCompleteSelection(OntoUMLParser.SORTAL_ANCESTORS,project);       	   				    	
	   		JOptionPane.showMessageDialog(
		...
		{
			if (ModelTree.getTreeFor(project)==null) return;       		    	
		   	String msg = DiagramManager.doAutoCompleteSelection(OntoUMLParser.ALL_DESCENDANTS,project);       	   				    	
	   		JOptionPane.showMessageDialog(
		...
		{
			if (ModelTree.getTreeFor(project)==null) return;       		    	
		   	String msg = DiagramManager.doAutoCompleteSelection(OntoUMLParser.NO_HIERARCHY,project);       	   				    	
	   		JOptionPane.showMessageDialog(
