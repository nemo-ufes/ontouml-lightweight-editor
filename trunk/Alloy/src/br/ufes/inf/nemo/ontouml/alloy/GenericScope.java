 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ontouml.alloy.GenericScope#getScopeable <em>Scopeable</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ontouml.alloy.GenericScope#getScopeSize <em>Scope Size</em>}</li>
 * </ul>
 * </p>
 *
 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getGenericScope()
 * @model
 * @generated
 */
public interface GenericScope extends ScopeSpecification {
	 ...
	 * The list contents are of type {@link br.ufes.inf.nemo.ontouml.alloy.Scopeable}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getGenericScope_Scopeable()
	 ...
	 * @see br.ufes.inf.nemo.ontouml.alloy.AlloyPackage#getGenericScope_ScopeSize()
	 * @model required="true"
	 * @generated
	 */
	int getScopeSize();
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.ontouml.alloy.GenericScope#getScopeSize <em>Scope Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
