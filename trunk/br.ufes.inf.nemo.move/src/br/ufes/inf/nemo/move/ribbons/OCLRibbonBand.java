...
public class OCLRibbonBand extends JRibbonBand {
	...
	public OCLRibbonBand(TheFrame frame, String title, ResizableIcon icon) 
	{
		super(title, icon);
		...
		addCommandButton(parseButton, RibbonElementPriority.MEDIUM);	
