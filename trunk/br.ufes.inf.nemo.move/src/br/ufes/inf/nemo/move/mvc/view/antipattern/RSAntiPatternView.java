...
public class RSAntiPatternView extends JPanel {
	 ...
	 * @param frame
	 */
	public RSAntiPatternView(RSAntiPatternModel rsModel, TheFrame frame) 
	{
		this();
		...
		textGeneralSource.setText("  "+rsModel.getRSAntiPattern().getGeneralSource().getName());
		textGeneralTarget.setText("  "+rsModel.getRSAntiPattern().getGeneralTarget().getName());
		textGeneralAssociation.setText("  "+rsModel.getRSAntiPattern().getGeneral().getName());
		textSpecificAssociation.setText("  "+rsModel.getRSAntiPattern().getSpecific().getName());
		textSpecificSource.setText("  "+rsModel.getRSAntiPattern().getSpecificSource().getName());
		textSpecificTarget.setText("  "+rsModel.getRSAntiPattern().getSpecificTarget().getName());
		
		lblRelationSpecialization.setText("Relation Specialization "+rsModel.getId());
	}	
	
	/**
	 * Constructor.
	 */
	public RSAntiPatternView() 
	{
