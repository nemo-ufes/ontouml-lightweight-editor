...
public class AntiPatternModificationsDialog extends Dialog {
	 ...
	 */
	public AntiPatternModificationsDialog(Shell parentShell) {
		super(parentShell);
	}

	public AntiPatternModificationsDialog(Shell parentShell, Fix fix, AppFrame frame)
	{
		super(parentShell);
		this.fix = fix;
		this.frame = frame;
		setDefaultImage(new Image(Display.getDefault(),AntiPatternModificationsDialog.class.getResourceAsStream("/resources/br/ufes/inf/nemo/oled/ui/antipattern-36x36.png")));	
	}
...
//		    public void run() {
				...
				AntiPatternModificationsDialog resultDIalog = new AntiPatternModificationsDialog(shell, fix, frame);				
				resultDIalog.create();				
				resultDIalog.open();
//		    }
//    	});		
