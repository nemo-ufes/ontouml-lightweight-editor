...
//	  }
  ...
  {
	  int count=0;
	  if (elementCounters.get(elementType)!=null) count = elementCounters.get(elementType);
  ...
  {	  
	  int count = 0;
	  if(relationCounters.get(relationType)!=null) count=relationCounters.get(relationType);	  
