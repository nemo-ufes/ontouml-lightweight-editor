...
public class CreationHandler implements EditorMode {
	...
	public void mousePressed(EditorMouseEvent event) {
		...
		if(element!=null){
			...
			//Model Completer. by Victor
			if (!isDragging && !elementType.equals(ElementType.PATTERN_COMPLETER)) {
				editor.getDiagramManager().runModelCompleter(elem, tmpPos.getX(), tmpPos.getY());
			}
		}else{	   
			...
			}else if( (elementType == ElementType.SOFFERING) || (elementType == ElementType.SAGREEMENT) ){
