...
public class OntoUMLBar extends JPanel {
	...
	public OntoUMLBar() 
	{
		...
		btnOpen.setIcon(new ImageIcon(OntoUMLBar.class.getResource("/resources/icon/open-16x16.png")));
		...
		btnShowUnique.setIcon(new ImageIcon(OntoUMLBar.class.getResource("/resources/icon/label2-16x16.png")));
