...
public class TemporalOCLParser {
	...
	{		
		...
		String pivotPath = "C:\\Users\\Guerson\\SVN\\OLED-SVN\\br.ufes.inf.nemo.tocl2alloy\\model\\project.pivot";
		...
		for (ContextConstraintCS tocl_prop : tocl_rules)
		{
			if (tocl_prop instanceof TempCS)
			{
				...
				ExpressionInOCL pivotSpecification = PivotUtil.getPivot(ExpressionInOCL.class, spec);
				System.out.println("expressioninocl = "+pivotSpecification);
