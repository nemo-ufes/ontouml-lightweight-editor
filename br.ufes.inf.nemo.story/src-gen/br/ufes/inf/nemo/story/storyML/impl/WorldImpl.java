 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.story.storyML.impl.WorldImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorldImpl extends Story_elementImpl implements World
{
  ...
  {
    return StoryMLPackage.Literals.WORLD;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StoryMLPackage.WORLD__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StoryMLPackage.WORLD__NAME:
        return getName();
    }
