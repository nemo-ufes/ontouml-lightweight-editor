 ...
 * @generated
 */
public class SituationTypeImpl extends MinimalEObjectImpl.Container implements SituationType {
	/**
	...
	protected EClass eStaticClass() {
		return Sml2Package.Literals.SITUATION_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Sml2Package.SITUATION_TYPE__NAME, oldName, name));
	}
