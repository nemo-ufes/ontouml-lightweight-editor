 ...
 * <ul>
 *   <li>{@link sml2.impl.ClassLiteralImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassLiteralImpl extends LiteralImpl implements ClassLiteral {
	...
	protected EClass eStaticClass() {
		return Sml2Package.Literals.CLASS_LITERAL;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Sml2Package.CLASS_LITERAL__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(RefOntoUML.Class newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Sml2Package.CLASS_LITERAL__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Sml2Package.CLASS_LITERAL__TYPE:
