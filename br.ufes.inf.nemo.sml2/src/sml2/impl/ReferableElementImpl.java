...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Referable Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public abstract class ReferableElementImpl extends NodeImpl implements ReferableElement {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ReferableElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Sml2Package.Literals.REFERABLE_ELEMENT;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == SituationTypeElement.class) {
			switch (baseOperationID) {
				case Sml2Package.SITUATION_TYPE_ELEMENT___GET_SITUATION: return Sml2Package.REFERABLE_ELEMENT___GET_SITUATION;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Sml2Package.REFERABLE_ELEMENT___GET_SITUATION:
				return getSituation();
		}
