...
{	  
    ...
    {    	
		...
		// Enforces the correct use of collect. 
    ...
    {     
        ...
        {        	     
            ...
            if(name.equals("closure")) var = string;
        ...
        if(name.equals("collect")) 
        {        	
        	// Substitue a variavel x por sourceResult na expressao bodyResult
        ...
        if(name.equals("isUnique")) 
        {
        	...
        	// Substitue a variavel x por x' na expressao bodyResult 
